<template>
  <div
    class="min-h-screen bg-gradient-to-br from-pink-50/20 via-purple-50/15 to-blue-50/10">
    <NavBarComponent />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div
        ...
        <p class="text-gray-500 mb-8">Save your favorite products for later!</p>
        <router-link
          to="/product"
        ...
        <div
          ...
          <div class="relative aspect-square overflow-hidden bg-gray-50">
            ...
            <button
              ...
              class="absolute top-3 right-3 bg-white/90 backdrop-blur-sm p-2 rounded-full shadow-lg hover:bg-red-500 hover:text-white transition-all group/btn">
            ...
            <button
              ...
              class="absolute bottom-3 left-3 right-3 bg-neutral-900 text-white py-2 px-4 rounded-lg opacity-0 group-hover:opacity-100 transition-all transform translate-y-2 group-hover:translate-y-0 hover:bg-neutral-800 font-medium">
              Add to Cart
            </button>
          </div>
      ...
      <div v-if="wishlistCount > 0" class="mt-8 text-center">
        <button
          ...
          class="px-6 py-3 text-red-600 border-2 border-red-600 rounded-xl hover:bg-red-600 hover:text-white transition-all font-medium">
          Clear Wishlist
        </button>
      </div>
    </div>
