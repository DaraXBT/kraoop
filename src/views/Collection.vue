<template>
  <div
    class="min-h-screen bg-gradient-to-br from-purple-50/15 via-pink-50/20 to-blue-50/10">
    <NavBarComponentVue />
    <AnnouncementBanner />
      ...
      <div class="flex flex-col lg:flex-row gap-8 lg:gap-10">
        ...
        <aside class="w-full lg:w-72 flex-shrink-0">
          ...
          <button
            ...
            class="lg:hidden w-full mb-4 px-6 py-4 bg-[#F5A3B7] text-white rounded-xl font-semibold flex items-center justify-between min-h-[48px] shadow-sm hover:bg-[#e392a6] transition-colors">
          ...
          <div :class="{'hidden lg:block': !showFilters}" class="space-y-6">
            <!-- Collection Section -->
            <div class="menu-product bg-white p-5 sm:p-6 rounded-xl shadow-sm">
