          ...
          <div
            ...
            <div class="space-y-6">
              ...
              <div v-if="isEditing" class="flex gap-4 pt-4">
                <button
                  @click="toggleEdit"
                  class="flex-1 px-6 py-3 bg-[#F5A3B7] text-white rounded-lg hover:bg-[#e392a6] transition-colors font-medium">
                  Save Changes
                </button>
                <button
                  @click="cancelEdit"
                  class="flex-1 px-6 py-3 bg-gray-200 text-[#383838] rounded-lg hover:bg-gray-300 transition-colors font-medium">
                  Cancel
                </button>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div
                ...
                <div class="flex gap-2">
                  <button
                    class="flex-1 px-4 py-2 bg-[#F5A3B7] text-white rounded-lg hover:bg-[#e392a6] transition-colors text-sm">
                    Add to Cart
                  </button>
                  <button
                    @click="removeFromWishlist(item.id)"
                    class="px-4 py-2 border border-gray-300 text-[#697586] rounded-lg hover:bg-gray-50 transition-colors">
                    <svg
                      class="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
            ...
            <div class="space-y-4">
              <div
                ...
                <button
                  ...
                  class="text-sm text-[#F5A3B7] hover:underline">
                  Set as default
                </button>
              </div>
            </div>
              ...
              <div class="border-b border-gray-200 pb-6">
                ...
                <div class="space-y-3">
                  ...
                  <label
                    class="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-gray-50 transition-all">
                    <div class="checkbox-wrapper-account">
                      <input type="checkbox" class="modern-checkbox-account" />
                      <span class="checkbox-custom-account">
                        <svg
                          class="checkbox-icon-account"
                          viewBox="0 0 24 24"
