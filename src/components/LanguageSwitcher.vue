...
const currentFlag = computed(() => locale.value);
</script>

<template>
  <button 
    @click="toggleLanguage"
    class="flex items-center justify-center gap-2 p-2 rounded-lg hover:bg-white/10 transition-smooth group"
    :title="locale === 'en' ? 'Switch to Khmer' : 'ប្តូរទៅភាសាអង់គ្លេស'"
  >
    <!-- English Option -->
    <div v-if="locale === 'en'" class="flex items-center gap-2">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" class="rounded-[4px] shadow-sm">
      ...
      <span class="text-xs font-semibold text-gray-700 group-hover:text-gray-900">English</span>
    </div>
    ...
    <div v-else class="flex items-center gap-2">
      ...
      <span class="text-xs font-semibold text-gray-700 group-hover:text-gray-900 font-kantumruy">ភាសាខ្មែរ</span>
    </div>
  </button>
</template>
